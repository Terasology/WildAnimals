...
public class AttackOnHitSystem extends BaseComponentSystem {
    ...
    public void onUpdateBehaviorAttack(UpdateBehaviorEvent event, EntityRef entity, AttackOnHitComponent attackOnHitComponent) {
        ...
        @ReceiveEvent(priority = EventPriority.PRIORITY_LOW, components = AttackOnHitComponent.class)
        public void onUpdateBehaviorStray(UpdateBehaviorEvent event, EntityRef entity, AttackOnHitComponent attackOnHitComponent) {
            ...
            CharacterMovementComponent characterMovementComponent = entity.getComponent(CharacterMovementComponent.class);
            characterMovementComponent.speedMultiplier = attackOnHitComponent.defaultSpeedMultipler;
            entity.saveComponent(characterMovementComponent);
