 ...
 */
package org.terasology.wildAnimals.action;
...
public class SetTargetToFollowedEntityAction extends BaseAction {
    ...
    public BehaviorState modify(Actor actor, BehaviorState result) {
        ...
        if (moveComponent.currentBlock != null) {
            moveComponent.target = actor.getComponent(FollowComponent.class).entityToFollow.getComponent(LocationComponent.class).getWorldPosition();
